        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="flex flex-wrap gap-6 mt-6 pt-6 border-t border-gray-100">
            ...
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span className="font-medium mr-1">Stars:</span>{" "}
              {project.stars_count.toLocaleString()}
            </div>
            <div className="flex items-center text-sm text-gray-600">
              <GitFork className="h-5 w-5 mr-2 text-blue-400" />
              <span className="font-medium mr-1">Forks:</span>{" "}
            ...
            {project.github_created_at && (
              <div className="flex items-center text-sm text-gray-600">
                ...
                {format(new Date(project.github_created_at), "MMM d, yyyy")}
              </div>
            )}
            {project.github_updated_at && (
              <div className="flex items-center text-sm text-gray-600">
                ...
                {format(new Date(project.github_updated_at), "MMM d, yyyy")}
              </div>
            )}
          </div>
        </div>
